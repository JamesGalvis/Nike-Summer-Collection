      ...
      <div className="px-6 py-4">
        <div className="flex justify-center items-center">
          <img
            src={imgUrl}
            alt="Nike shoe"
            className="rotate-[10deg] w-[190px] h-[190px] z-10 group-hover:-translate-y-3 transition-transform duration-700"
          />
        </div>
        ...
        <div className="flex justify-between items-center">
          <p className="font-montserrat text-xl font-semibold text-coral-red leading-normal mt-2">
            {price}
          </p>

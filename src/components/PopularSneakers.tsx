...
function PopularSneakers() {
  return (
    <section id="products" className="max-container mt-14">
      <div className="padding-x">
        <h2 className="text-[48px] font-bold font-palanquin">
          Sneakers <span className="text-coral-red">Populares</span>
        </h2>
        ...
        <div className="overflow-hidden grid place-items-center lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 sm:gap-y-10 sm:gap-x-4 gap-14 mt-16">
